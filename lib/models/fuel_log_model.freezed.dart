...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,vehicleId,odometer,fuelQuantity,totalCost,stationName,date,fuelPrice,remainingRange,remainingRangeAfter,isFullTank,location,notes,paymentMethod,billImagePath);
...
switch (_that) {
case _FuelLog() when $default != null:
return $default(_that.id,_that.userId,_that.vehicleId,_that.odometer,_that.fuelQuantity,_that.totalCost,_that.stationName,_that.date,_that.fuelPrice,_that.remainingRange,_that.remainingRangeAfter,_that.isFullTank,_that.location,_that.notes,_that.paymentMethod,_that.billImagePath);case _:
  return orElse();
