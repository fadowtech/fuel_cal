...
@override
String toString() {
  return 'Service(id: $id, userId: $userId, vehicleId: $vehicleId, category: $category, title: $title, amount: $amount, date: $date, notes: $notes)';
}
...
class _Service implements Service {
  const _Service({required this.id, @JsonKey(name: 'user_id') required this.userId, @JsonKey(name: 'vehicle_id') this.vehicleId, required this.category, required this.title, required this.amount, this.date, this.notes});
